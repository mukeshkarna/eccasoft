          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">CTC Code</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Temporary Address</label>
                  <div class="col-sm-10">
                  <textarea class="form-control" rows="3" placeholder="Enter ..."></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">CTC Year</label>
